...
namespace DnD5e.Creatures.Items.Armors.Core.HideArmors
{
    ...
    /// </summary>
    public sealed class HideArmorPlusOne : MediumArmor, IHideArmor, IEnchantedItem
    {
        #region Properties
        /// <summary>
        /// The base armor class to bestow upon the creature wearing this armor.
        /// </summary>
        public override byte BaseArmorValue => 13;

        /// <summary>
        /// The name of this armor.
        /// </summary>
        public override string Name => "+1 Hide Armor";
