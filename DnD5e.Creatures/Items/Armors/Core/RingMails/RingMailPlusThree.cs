...
namespace DnD5e.Creatures.Items.Armors.Core.RingMails
{
    ...
    /// </summary>
    public sealed class RingMailPlusThree : HeavyArmor, IRingMail, IEnchantedItem
    {
        #region Properties
        /// <summary>
        /// The base armor class to bestow upon the creature wearing this armor.
        /// </summary>
        public override byte BaseArmorValue => 17;

        /// <summary>
        /// The name of this armor.
        /// </summary>
        public override string Name => "+3 Ring Mail";
