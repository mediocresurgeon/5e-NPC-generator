...
namespace DnD5e.Creatures.Items.Weapons.Core.Mauls
{
    /// <summary>
    /// A maul with an enhancement bonus.
    /// </summary>
    public sealed class MaulEnhanced : Maul, IEnchantedItem, IApplyable
    {
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="T:DnD5e.Creatures.Items.Weapons.Core.Mauls.MaulEnhanced"/> class.
        /// </summary>
        /// <param name="enhancementBonus">The enhancement bonus.  Should be no less than 1 and no greater than 3.</param>
        /// <exception cref="System.ArgumentOutOfRangeException" />
        public MaulEnhanced(byte enhancementBonus)
        {
        ...
        /// </summary>
        public override Uri Url => new Uri($"https://roll20.net/compendium/dnd5e/Maul%20+{ this.EnhancementBonus }#content");
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="T:DnD5e.Creatures.Items.Weapons.Core.Mauls.MaulEnhanced"/>
        /// requires atunement.
        /// </summary>
        ...
        #region Methods
        /// <summary>
        /// Applies the effects of this maul to a creature.
        /// </summary>
