...
namespace DnD5e.Creatures.Items.Weapons.Core.Mauls
{
    ...
    /// A two-handed hammer.
    /// </summary>
    public class Maul : IMaul
    {
        /// <summary>
        /// The name of this weapon.
        /// </summary>
        public virtual string Name => "Maul";
        ...
        /// </summary>
        public virtual Uri Url => new Uri("https://roll20.net/compendium/dnd5e/Items:Maul#content");

        /// <summary>
        /// The market value of this weapon (in gold pieces).
        /// </summary>
        public virtual decimal? MarketValue => 10;

        /// <summary>
        /// The weight of this weapon (in pounds).
        /// </summary>
        public virtual float Weight => 10;

        /// <summary>
        /// Returns the type of damage this weapon deals.
        /// </summary>
        public virtual WeaponDamageType DamageType => WeaponDamageType.Bludgeoning;

        /// <summary>
        /// Returns this weapon's default damage dice.
        /// </summary>
        public virtual IDiceGroup DamageDice { get; } = new DiceGroup(2, 6);
        ...
        /// </summary>
        public virtual byte? RangeIncrement1 => null;

        /// <summary>
        /// Returns this weapon's second range increment (in squares).
        /// </summary>
        public virtual byte? RangeIncrement2 => null;
