...
namespace DnD5e.Creatures.Dice
{
    internal sealed class DiceBag : IDiceBag
    {
        ...
        /// <summary>
        /// Returns the number of dice in this <see cref="T:DnD5e.Creatures.Dice.DiceBag"/>.
        /// </summary>
        ...
        #region Methods
        /// <summary>
        /// Adds dice into this <see cref="T:DnD5e.Creatures.Dice.DiceBag"/>.
        /// </summary>
        ...
        /// <summary>
        /// Rolls the dice in this <see cref="T:DnD5e.Creatures.Dice.DiceBag"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns a <see cref="T:System.String"/> that represents the current <see cref="T:DnD5e.Creatures.Dice.DiceBag"/>.
        /// </summary>
        /// <returns>A <see cref="T:System.String"/> that represents the current <see cref="T:DnD5e.Creatures.Dice.DiceBag"/>.</returns>
