...
namespace DnD5e.Creatures.Dice
{
    ...
    {
        /// <summary>
        /// Returns the number of dice in this <see cref="T:DnD5e.Creatures.Dice.IDiceBag"/>.
        /// </summary>
        byte Count { get; }
        ...
        /// <summary>
        /// Adds dice into this <see cref="T:DnD5e.Creatures.Dice.IDiceBag"/>.
        /// </summary>
        /// <param name="dice">The dice to add.</param>
        void Add(IDiceGroup dice);

        /// <summary>
        /// Rolls the dice in this <see cref="T:DnD5e.Creatures.Dice.IDiceBag"/>.
        /// </summary>
